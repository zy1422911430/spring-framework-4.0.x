...
public final class FactoryBeanTests {
	...
	@Test
	public void testXmlBeanFactoryBean(){
		BeanFactory beanFactory = new XmlBeanFactory(new ClassPathResource("org/springframework/beans/factory/XmlBeanFactoryUtilsTests.xml"));
		TestBean test = (TestBean) beanFactory.getBean("test");
